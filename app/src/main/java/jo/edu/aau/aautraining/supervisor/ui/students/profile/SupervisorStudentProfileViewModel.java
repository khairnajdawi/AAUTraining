...
public class SupervisorStudentProfileViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<Integer> attendDaysCount, absenceDaysCount, trainingStatus, trainerId;

    public SupervisorStudentProfileViewModel(Application application) {
        super(application);
        ...
        attendDaysCount = new MutableLiveData<>();
        absenceDaysCount = new MutableLiveData<>();
        trainingStatus = new MutableLiveData<>();
        trainerId = new MutableLiveData<>();
    }

    public MutableLiveData<Integer> getTrainerId() {
        return trainerId;
    }

    public void setTrainerId(Integer trainerId) {
        this.trainerId.setValue(trainerId);
    }
    ...
    public MutableLiveData<Integer> getAttendDaysCount() {
        return attendDaysCount;
    }

    public void setAttendDaysCount(Integer attendDaysCount) {
        this.attendDaysCount.setValue(attendDaysCount);
    }

    public MutableLiveData<Integer> getAbsenceDaysCount() {
        return absenceDaysCount;
    }

    public void setAbsenceDaysCount(Integer absenceDaysCount) {
        this.absenceDaysCount.setValue(absenceDaysCount);
    }
